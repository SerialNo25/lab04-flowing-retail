...
public class MessageListener {
  ...
  private void emitStockUpdatedEvent() {
    messageSender.send(new Message<StockUpdatedEventPayload>("StockUpdatedEvent", new StockUpdatedEventPayload() //
            .setAvailable(inventoryService.getAvailableStock()) //
            .setSold(inventoryService.getSoldStock())));
  }
